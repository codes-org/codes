...
#endif
static dumpi_clock
timediff(dumpi_clock end, dumpi_clock start) {
    dumpi_clock temp;
...
static int handleDUMPIInit(const dumpi_init* prm, uint16_t thread, const dumpi_time* cpu,
...
int handleDUMPIError(const void* prm, uint16_t thread, const dumpi_time* cpu,
                     const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIIgnore(const void* prm, uint16_t thread, const dumpi_time* cpu,
                      const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
static void update_times_and_insert(struct codes_workload_op* op, const dumpi_time* t,
...
int handleDUMPIWait(const dumpi_wait* prm, uint16_t thread, const dumpi_time* cpu,
...
int handleDUMPIWaitsome(const dumpi_waitsome* prm, uint16_t thread, const dumpi_time* cpu,
                        const dumpi_time* wall, const dumpi_perfinfo* perf, void* userarg) {
    (void)thread;
    (void)cpu;
    (void)wall;
...
int handleDUMPIWaitany(const dumpi_waitany* prm, uint16_t thread, const dumpi_time* cpu,
                       const dumpi_time* wall, const dumpi_perfinfo* perf, void* userarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIWaitall(const dumpi_waitall* prm, uint16_t thread, const dumpi_time* cpu,
                       const dumpi_time* wall, const dumpi_perfinfo* perf, void* userarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIISend(const dumpi_isend* prm, uint16_t thread, const dumpi_time* cpu,
                     const dumpi_time* wall, const dumpi_perfinfo* perf, void* userarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIIRecv(const dumpi_irecv* prm, uint16_t thread, const dumpi_time* cpu,
                     const dumpi_time* wall, const dumpi_perfinfo* perf, void* userarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIRecv(const dumpi_recv* prm, uint16_t thread, const dumpi_time* cpu,
                    const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPISendrecv(const dumpi_sendrecv* prm, uint16_t thread, const dumpi_time* cpu,
                        const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIBcast(const dumpi_bcast* prm, uint16_t thread, const dumpi_time* cpu,
                     const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIAllgather(const dumpi_allgather* prm, uint16_t thread, const dumpi_time* cpu,
                         const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIAllgatherv(const dumpi_allgatherv* prm, uint16_t thread, const dumpi_time* cpu,
                          const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIAlltoall(const dumpi_alltoall* prm, uint16_t thread, const dumpi_time* cpu,
                        const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIAlltoallv(const dumpi_alltoallv* prm, uint16_t thread, const dumpi_time* cpu,
                         const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
    ...
    wrkld_per_rank.u.collective.num_bytes =
        prm->sendcounts[0] * get_num_bytes(myctx, prm->sendtype);
    assert(wrkld_per_rank.u.collective.num_bytes > 0);
...
int handleDUMPIReduce(const dumpi_reduce* prm, uint16_t thread, const dumpi_time* cpu,
                      const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIAllreduce(const dumpi_allreduce* prm, uint16_t thread, const dumpi_time* cpu,
                         const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIFinalize(const dumpi_finalize* prm, uint16_t thread, const dumpi_time* cpu,
                        const dumpi_time* wall, const dumpi_perfinfo* perf, void* uarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int handleDUMPIReqFree(const dumpi_request_free* prm, uint16_t thread, const dumpi_time* cpu,
                       const dumpi_time* wall, const dumpi_perfinfo* perf, void* userarg) {
    (void)prm;
    (void)thread;
    (void)cpu;
...
int dumpi_trace_nw_workload_load(const void* params, int app_id, int rank) {
...

    {
        ...
        for (i = 0; i < dumpi_params->num_net_traces; i++) {
            struct codes_jobmap_id id = {.job = app_id, .rank = i};
            uint32_t cn_id;
            if (jobmap_ctx) {
    ...
    while (active && !finalize_reached) {
        ...
        if (my_ctx->num_ops < max_threshold)
            active = cortex_undumpi_read_single_call(profile, callarr, transarr, (void*)my_ctx,
                                                     &finalize_reached);
        else {
