...
static void init_workload_methods(void) {
    ...
    if (method_array == NULL)
        ...
        method_array = realloc(method_array, (num_default_methods + num_user_methods + 1) *
                                                 sizeof(*method_array));
...
codes_workload_config_return codes_workload_read_config(ConfigHandle* handle,
    ...
    int rc = configuration_get_value(handle, section_name, "workload_type", annotation, type,
    ...
    for (int i = 0; method_array[i] != NULL; i++) {
        ...
        if (strcmp(m->method_name, type) == 0) {
            ...
            if (m->codes_workload_read_config == NULL)
                ...
                r.params =
                    m->codes_workload_read_config(handle, section_name, annotation, num_ranks);
        }
    }
...
int codes_workload_load(const char* type, const void* params, int app_id, int rank) {
    init_workload_methods();
...
void codes_workload_get_next_rc(int wkld_id, int app_id, int rank,
...
int codes_workload_get_time(const char* type, const char* params, int app_id, int rank,
                            double* read_time, double* write_time, int64_t* read_bytes,
    ...
    for (i = 0; method_array[i] != NULL; i++) {
        ...
        if (strcmp(method_array[i]->method_name, type) == 0) {
            if (method_array[i]->codes_workload_get_time != NULL)
                return method_array[i]->codes_workload_get_time(params, app_id, rank, read_time,
                                                                write_time, read_bytes,
                                                                written_bytes);
            else
                return -1;
        }
...
void codes_workload_print_op(FILE* f, struct codes_workload_op* op, int app_id, int rank) {
    ...
    case CODES_WK_SEND:
        fprintf(f,
                ...
                op->u.send.data_type, op->u.send.count, op->u.send.tag, op->start_time,
                op->end_time);
        break;
    case CODES_WK_RECV:
        fprintf(f,
                ...
                op->u.recv.data_type, op->u.recv.count, op->u.recv.tag, op->start_time,
                op->end_time);
        break;
    case CODES_WK_ISEND:
        fprintf(f,
...
char const* const op_type_string(enum codes_workload_op_type op_type) {
    ...
    case CODES_WK_END:
        return "CODES_WK_END";
    case CODES_WK_DELAY:
        return "CODES_WK_DELAY";
    case CODES_WK_BARRIER:
        return "CODES_WK_BARRIER";
    case CODES_WK_OPEN:
        return "CODES_WK_OPEN";
    case CODES_WK_CLOSE:
        return "CODES_WK_CLOSE";
    case CODES_WK_WRITE:
        return "CODES_WK_WRITE";
    case CODES_WK_READ:
        return "CODES_WK_READ";
    case CODES_WK_SEND:
        return "CODES_WK_SEND";
    case CODES_WK_RECV:
        return "CODES_WK_RECV";
    case CODES_WK_ISEND:
        return "CODES_WK_ISEND";
    case CODES_WK_IRECV:
        return "CODES_WK_IRECV";
    case CODES_WK_BCAST:
        return "CODES_WK_BCAST";
    case CODES_WK_ALLGATHER:
        return "CODES_WK_ALLGATHER";
    case CODES_WK_ALLGATHERV:
        return "CODES_WK_ALLGATHERV";
    case CODES_WK_ALLTOALL:
        return "CODES_WK_ALLTOALL";
    case CODES_WK_ALLTOALLV:
        return "CODES_WK_ALLTOALLV";
    case CODES_WK_REDUCE:
        return "CODES_WK_REDUCE";
    case CODES_WK_ALLREDUCE:
        return "CODES_WK_ALLREDUCE";
    case CODES_WK_COL:
        return "CODES_WK_COL";
    case CODES_WK_WAITALL:
        return "CODES_WK_WAITALL";
    case CODES_WK_WAIT:
        return "CODES_WK_WAIT";
    case CODES_WK_WAITSOME:
        return "CODES_WK_WAITSOME";
    case CODES_WK_WAITANY:
        return "CODES_WK_WAITANY";
    case CODES_WK_TESTALL:
        return "CODES_WK_TESTALL";
    case CODES_WK_REQ_FREE:
        return "CODES_WK_REQ_FREE";
    case CODES_WK_IGNORE:
        return "CODES_WK_IGNORE";
    case CODES_WK_MPI_OPEN:
        return "CODES_WK_MPI_OPEN";
    case CODES_WK_MPI_CLOSE:
        return "CODES_WK_MPI_CLOSE";
    case CODES_WK_MPI_WRITE:
        return "CODES_WK_MPI_WRITE";
    case CODES_WK_MPI_READ:
        return "CODES_WK_MPI_READ";
    case CODES_WK_MPI_COLL_OPEN:
        return "CODES_WK_MPI_COLL_OPEN";
    case CODES_WK_MPI_COLL_WRITE:
        return "CODES_WK_MPI_COLL_WRITE";
    case CODES_WK_MPI_COLL_READ:
        return "CODES_WK_MPI_COLL_READ";
    case CODES_WK_MARK:
        return "CODES_WK_MARK";
    default:
        return "UNKNOWN!!";
    }
}
