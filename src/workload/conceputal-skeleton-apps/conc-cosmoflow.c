 ...
 *           CODES_MPI_Allreduce([MESSAGE BUFFER 0], [MESSAGE BUFFER 1], (int)" and numwords and ",
...
thisev->s.delay.spin0sleep1 = 0;
 ...
 /* THEN... */
 /* ALL TASKS BACKEND EXECUTES ['"\\n        CODES_MPI_Allreduce([MESSAGE BUFFER 0], [MESSAGE BUFFER 1], (int)"', 'var_numwords', '",\\n                MPI_INT, MPI_SUM, MPI_COMM_WORLD);\\n        "'] */
{   /* ALL TASKS */
 /* The current coNCePTuaL statement applies to our task. */
 ...
 /* ALL TASKS BACKEND EXECUTES ['"\\n        CODES_MPI_Allreduce([MESSAGE BUFFER 0], [MESSAGE BUFFER 1], (int)"', 'var_numwords', '",\\n                MPI_INT, MPI_SUM, MPI_COMM_WORLD);\\n        "'] */
{
        ...
        CODES_MPI_Allreduce((ncptl_get_message_buffer ((ncptl_int)(0))), (ncptl_get_message_buffer ((ncptl_int)(1))), (int) (double)thisev->s.code.var_numwords ,
                MPI_INT, MPI_SUM, MPI_COMM_WORLD);
...
struct codes_conceptual_bench cosmoflow_bench = 
{
