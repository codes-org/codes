...
static ncptl_int var_nummsgs;   /* Number of messages per trial (command-line argument) */
static ncptl_int var_wups;   /* Number of warmup messages (command-line argument) */
static ncptl_int var_msgsize;   /* Message size in bytes (command-line argument) */
static ncptl_int var_numtrials;   /* Number of bisection patterns (command-line argument) */
static ncptl_int var_rounding;   /* Round measurements to the nearest N (command-line argument) */
...
(void) CODES_MPI_Bcast ((void *)&rndseed_int, 1, MPI_INT, 0, MPI_COMM_WORLD);
...
struct codes_conceptual_bench bisect_bench = 
{
.program_name = "bisect",
.conceptual_main = bisect_main,
};
