...
static int dump_section(FILE* f, struct ConfigVTable* h, SectionHandle s, unsigned int indent);

static int dump_entry(FILE* f, struct ConfigVTable* h, SectionHandle s, unsigned int indent,
