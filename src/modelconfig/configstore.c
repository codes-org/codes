...
/* Create text entry */
static mcs_entry* mcs_createvalue(const char* name, const char** values, unsigned int count) {
    mcs_entry* n = mcs_allocentry();
    unsigned int i;
...
mcs_entry* mcs_addkey(mcs_entry* e, const char* name, const char** values, unsigned int count) {
