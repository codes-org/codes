...
static model_net_event_return model_net_noop_event(tw_lpid final_dest_lp, int is_pull,
                                                   tw_stime offset, uint64_t message_size,
...
static model_net_event_return
model_net_event_impl_base(int net_id, struct codes_mctx const* send_map_ctx,
                          struct codes_mctx const* recv_map_ctx, char const* category,
                          tw_lpid final_dest_lp, uint64_t message_size, int is_pull,
                          tw_stime offset, int remote_event_size, void const* remote_event,
...
void model_net_event_collective(int net_id, char const* category, int message_size,
    ...
    return method_array[net_id]->mn_collective_call(category, message_size, remote_event_size,
                                                    remote_event, sender);
}
