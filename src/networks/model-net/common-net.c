...
void append_to_message_list(message_list** thisq, message_list** thistail, int index,
                            message_list* msg) {
    if (thisq[index] == NULL) {
        thisq[index] = msg;
    } else {
...
void prepend_to_message_list(message_list** thisq, message_list** thistail, int index,
                             message_list* msg) {
    if (thisq[index] == NULL) {
        thistail[index] = msg;
    } else {
...
message_list* return_head(message_list** thisq, message_list** thistail, int index) {
...
message_list* return_tail(message_list** thisq, message_list** thistail, int index) {
...
void delete_from_message_list(message_list*** allq, message_list*** alltail, message_list* msg) {
...
void add_to_message_list(message_list*** allq, message_list*** alltail, message_list* msg) {
    message_list** thisq = allq[msg->port];
    message_list** thistail = alltail[msg->port];
...
void altq_append_to_message_list(message_list** thisq, message_list** thistail, int index,
                                 message_list* msg) {
    assert(index == 0);
    if (thisq[index] == NULL) {
        thisq[index] = msg;
...
void altq_prepend_to_message_list(message_list** thisq, message_list** thistail, int index,
                                  message_list* msg) {
    assert(index == 0);
    if (thisq[index] == NULL) {
        thistail[index] = msg;
...
message_list* altq_return_head(message_list** thisq, message_list** thistail, int index) {
    assert(index == 0);
    message_list* head = thisq[index];
    if (head != NULL) {
...
message_list* altq_return_tail(message_list** thisq, message_list** thistail, int index) {
    assert(index == 0);
    message_list* tail = thistail[index];
    assert(tail);
...
void altq_add_to_message_list(message_list*** allq, message_list*** alltail, message_list* msg) {
    message_list** thisq = allq[msg->altq_port];
    message_list** thistail = alltail[msg->altq_port];
...
void delete_message_list(void* thisM) {
    ...
    if (thism->event_data != NULL)
        free(thism->event_data);
    free(thism);
}
