...
struct codes_nw_workload_method dumpi_trace_workload_method =
{
    .method_name = "dumpi-trace-workload",
    .codes_nw_workload_load = dumpi_trace_nw_workload_load,
    .codes_nw_workload_get_next = dumpi_trace_nw_workload_get_next,
};
